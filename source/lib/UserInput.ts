...
export class UserInput extends Stateful {
  ...
  onKeyDown(e: KeyboardEvent): void {
    ...
    if (e.key === 'Escape') {
      ...
      this.updateResult(UserOperation.HotKey)
  }
  ...
  private getHotKey(): string {
    let result: string = ''
    const k = this.keyDown
    if (k !== '' && k !== 'Control' && k !== 'Shift' && k !== 'Alt') {
      switch (this.resultModifiers) {
        ...
        case KeyboardModifiers.Shift:
          result = 'Shift+' + k
          break
        case KeyboardModifiers.CtrlShift:
          result = 'Ctrl+Shift+' + k
          break
        case KeyboardModifiers.Alt:
          result = 'Alt+' + k
          break
        case KeyboardModifiers.CtrlAlt:
          result = 'Ctrl+Alt+' + k
          break
        case KeyboardModifiers.CtrlShiftAlt:
          result = 'Ctrl+Shift+Alt+' + k
          break
        case KeyboardModifiers.ShiftAlt:
          result = 'Shift+Alt+' + k
          break
